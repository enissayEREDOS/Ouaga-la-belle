...
<form id="editsiteForm" method="post" class="formulaire" action="" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="lat" name="lat" value="{{$site->latitude}}" required>
    </div>
    <div class="form-group">
        <label for="lng">Longitude</label>
        <input type="text" class="form-control" id="lng" name="lng"  value="{{$site->longitude}}" required>
    </div>
    <div class="form-group">
